...
let arrForBoardCards = arrCardImages.concat(arrCardImages).sort(() => 0.5 - Math.random())
...
function flipCard(){
    ...
    this.setAttribute("src", arrCardImages.find((arr) => arr.name === this.id).image)
...
function checkMatch(){
    ...
    else
    {
        alert('loss')
        console.log("loss");
        let reWhiteCards = document.querySelectorAll("img#"+arrChoosenCards[0]+",img#"+arrChoosenCards[1])
